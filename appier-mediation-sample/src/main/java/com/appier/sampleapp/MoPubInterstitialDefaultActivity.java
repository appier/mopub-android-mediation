...
public class MoPubInterstitialDefaultActivity extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mopub_interstitial_default);
        ...
        mInterstitial = new MoPubInterstitial(this, getString(R.string.adunit_appier_interstitial_sample_with_mopub));
